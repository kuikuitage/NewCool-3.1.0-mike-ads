...
typedef struct
{
	...
	u32 epgDay;
	al_iptv_info_url_epg_lit_t *epgList;
...
typedef struct
{
	u32 count;
	u8 *epgTitle;
}al_iptv_play_origin_epg_list_t;
...
typedef struct
{
	...
	u32 epg_force;
	u32 epg_count;
	al_iptv_play_origin_epg_list_t *epg_list;
...
{
    char playUrl[IPTV_URL_LEN];//播放地址
