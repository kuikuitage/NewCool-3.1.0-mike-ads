...
void sys_status_get_fav_iptv(iptv_fav *fav_iptv)
{
  ...
  {
	 memcpy(fav_iptv, &(status->xm_fav_iptv_pg), sizeof(iptv_fav));
  }
}
...
void sys_status_set_fav_iptv(iptv_fav *fav_iptv)
{
  ...
  {
	memcpy(&(status->xm_fav_iptv_pg),fav_iptv, sizeof(iptv_fav));
  }
}
...
void sys_status_set_fav_iptv_info(u32 index,iptv_fav_info *fav_iptv_info)
{
  ...
  {
	memcpy(&(status->xm_fav_iptv_pg.iptv_fav_pg[index]), fav_iptv_info, sizeof(iptv_fav_info));
  }
}
...
void sys_status_get_fav_iptv_info(u32 index,iptv_fav_info *ip_tv_info)
{
  ...
  {
	memcpy(ip_tv_info, &(status->xm_fav_iptv_pg.iptv_fav_pg[index]), sizeof(iptv_fav_info));
  }
}
...
void sys_status_del_fav_iptv_info(u32 index)
{
  ...
  {
	cnt = status->xm_fav_iptv_pg.iptv_total_num - (index + 1);
	status->xm_fav_iptv_pg.iptv_total_num --;
	memmove( &(status->xm_fav_iptv_pg.iptv_fav_pg[index]),&(status->xm_fav_iptv_pg.iptv_fav_pg[index + 1]), 
	     sizeof(iptv_fav_info) * cnt);
  }
}
...
void sys_status_set_fav_iptv_total_num(u32 total_num)
{
  ...
  {
	status->xm_fav_iptv_pg.iptv_total_num= total_num;
  }
}
...
void sys_status_get_fav_iptv_total_num(u32 *total_num)
{
  ...
  {
	*total_num = status->xm_fav_iptv_pg.iptv_total_num;
  }
}
...
db_play_hist_item *sys_status_get_play_hist_table(void)
{
  ...
  if (IPTV_ID_IQY ==  ui_iptv_dp_get_iptvId())
 {
  ...
  {
	return status->xm_play_hist_table;
  }
}
...
void sys_status_read_play_hist_item(u16 pos, db_play_hist_item *item)
{
  ...
  {
	 memcpy(item, status->xm_play_hist_table + pos, sizeof(db_play_hist_item));
  }
}
...
void sys_status_write_play_hist_item(u16 pos, db_play_hist_item *item)
{
  ...
  {
	memcpy(status->xm_play_hist_table + pos, item, sizeof(db_play_hist_item));
  }
}
...
s32 sys_status_find_free_play_hist_item(void)
{
  ...
  {
	p_table = status->xm_play_hist_table;
  }
