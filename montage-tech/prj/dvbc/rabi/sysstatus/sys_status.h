...
#define FAV_IPTV_NUM       (50)//(100)
#define MAX_CONN_PLAY_CNT (100)
#define MAX_PLAY_HIST_CNT (10)//(20)
...
#define SEARCH_FREQ_MIN 45000
#else
#define SEARCH_FREQ_MIN 474000
#endif
#define SEARCH_FREQ_MAX 864000
#else
#define SEARCH_FREQ_MIN 45000
#define SEARCH_FREQ_MAX 862000
#endif
...
{
  u32 iptv_total_num;
  iptv_fav_info iptv_fav_pg[FAV_IPTV_NUM];//FAV_IPTV_NUM
}iptv_fav;
...
typedef struct
{
  ...
  /* nit version */
  u8 nit_version;                    //Byte:132
  
#ifdef TF_CA
  ca_upgrade_info_t ca_upgrade_info;
#endif
  /*biss  key */
...
void sys_status_add_keynr(unsigned char Type);
...
#define  	IDENTITY_BLOCK_SIZE			(1024)
#define  	IDENTITY_BLOCK_START			(0)
#define 	STB_SN_MAX_LEN				(32)
#define    STB_MAC_ADDR_START			(IDENTITY_BLOCK_START + STB_SN_MAX_LEN)
#define    STB_MAC_ADDR_LEN				(12)

#define    STB_CHIPID_ADDR_START		(STB_MAC_ADDR_START + STB_MAC_ADDR_LEN)
#define    STB_CHIPID_ADDR_LEN			(16)

#define  	STB_SERIAL_MAX_LEN			(128)
#define 	USER_ID_OFFSET					(IDENTITY_BLOCK_START + STB_SERIAL_MAX_LEN)
#define 	USER_ID_MAX_LEN				(64)
	
#define 	IQY_IDENTITY_INFO_OFFSET		(USER_ID_OFFSET + USER_ID_OFFSET)
#define 	IQY_IDENTITY_INFO_MAX_LEN	(64)
