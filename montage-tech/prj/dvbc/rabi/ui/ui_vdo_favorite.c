...
{  	
  ...
  {
  		p_param.vdo_id.tvQid[0] = 0;
		p_param.vdo_id.vid[0] = 0;
	    memcpy(p_param.vdo_id.info_url, fav_iptv_info.iptv_fav_vdo_id.info_url, strlen(fav_iptv_info.iptv_fav_vdo_id.info_url)+1);
  }
