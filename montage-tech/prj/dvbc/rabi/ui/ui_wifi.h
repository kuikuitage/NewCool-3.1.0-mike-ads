...
#define WIFI_CONT_W       RIGHT_ROOT_W //1040
#define WIFI_CONT_H       RIGHT_ROOT_H// 605//580//(2 * TIMER_TITLE_Y + TIMER_TITLE_H + TIMER_ITEM_CNT * (TIMER_ITEM_H + TIMER_ITEM_V_GAP) + TIMER_BTN_H + 2*TIMER_ITEM_V_GAP)
...
#define WIFI_STATUS_CONT_X 		60
#define WIFI_STATUS_CONT_Y 		20
#define WIFI_STATUS_CONT_W 		(RIGHT_ROOT_W-2*WIFI_STATUS_CONT_X)
...
//wifi list
#define WIFI_LIST_X  WIFI_STATUS_CONT_X
