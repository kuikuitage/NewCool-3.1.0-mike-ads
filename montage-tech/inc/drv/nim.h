...
typedef enum nim_ioctrl_cmd 
{
    ...
    */  
    ...
    /*!
      ...
      */
    NIM_IOCTRL_PRINT_CHANNEL_INFO = DEV_IOCTRL_TYPE_LOCK + 24, 
...
typedef enum 
{
  /*!
    lock state undefine
    */
  NIM_LOCK_STATE_UNDEF = 0,
  /*!
    nim unlock
    */
  NIM_LOCK_STATE_UNLOCKED = 1,
  /*!
    nim lock
    */
  NIM_LOCK_STATE_LOCKED = 2,
  /*!
    nim waiting
    */
  NIM_LOCK_STATE_WAITING = 3
}nim_lock_state_t;
